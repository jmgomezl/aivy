...
const steps: DemoStep[] = [
  {
    ...
    body: 'Each AI agent has its own Hedera wallet, on-chain vault, and spending cap. Click one to start chatting.',
  ...
  },
  {
    ...
    body: 'Each agent has pre-built prompts that trigger real Hedera tools — balances, transfers, tokens, and more.',
  ...
  },
  {
    ...
    body: 'The agent called a Hedera tool and returned a live on-chain result with rich formatting — verifiable on the mirror node.',
    cardPos: 'left',
    trigger: 'auto',
    autoMs: 5000,
  ...
  },
  {
    ...
    body: 'The central hub — type any request and Aivy automatically routes it to the best agent. Try "What tokens do I have?" or anything else.',
  ...
  },
  {
    ...
    title: 'Smart routing',
    body: 'Aivy analyzed your request and picked the right agent — no manual selection needed. Agents can also coordinate with each other.',
    cardPos: 'top',
    trigger: 'auto',
    autoMs: 5000,
  ...
  },
  {
    ...
    body: 'Expand your swarm — deploy another AI agent with its own dedicated wallet, vault spending cap, and audit trail.',
  ...
  },
  {
    ...
    body: 'This creates a real smart contract vault and consensus audit topic on Hedera testnet. Set the initial funding and spending cap.',
  ...
  },
  {
    ...
    body: 'Your AI agent office is live on Hedera. Explore the Spending tab, set up Schedules, and watch agents coordinate.',
    cardPos: 'bottom',
    trigger: 'auto',
    autoMs: 10000,
  },
